...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class HatchSpiritEvolutionPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            bool shouldCheckInventory = extraEvolution.Requireds.Any(m => m.ItemId != 98699 && m.ItemId != 98700);

            if (shouldCheckInventory)
            {
                // Nenhuma verificação adicional necessária aqui
            }
            ...
            // VERIFICAÇÃO DO SLOT DISPONÍVEL
            ...
            if (digimonSlot == null || client.Tamer.Digimons.Count >= client.Tamer.DigimonSlots)
            {
                client.Send(new SystemMessagePacket("Você atingiu o limite máximo de Digimons."));
                return;
            }
