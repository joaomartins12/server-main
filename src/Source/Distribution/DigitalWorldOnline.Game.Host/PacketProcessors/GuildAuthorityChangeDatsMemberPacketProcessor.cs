...
{
    public class GuildAuthorityChangeDatsMemberPacketProcessor : IGamePacketProcessor
    {
        public GameServerPacketEnum Type => GameServerPacketEnum.GuildAuthorityChangeToDatsMember;
        ...
        public GuildAuthorityChangeDatsMemberPacketProcessor(
            MapServer mapServer,
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            {
                var newAuthority = GuildAuthorityTypeEnum.DatsMember;
