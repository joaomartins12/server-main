...
namespace DigitalWorldOnline.Commons.Models.Digimon
{
    public sealed partial class DigimonModel
    {
        ...
        private int _baseCd => (short)BaseStatus.CDValue;
        ...
        public byte FS
        {
            get
            {
                ...
                return (byte)(totalFs > 125 ? 125 : totalFs);
            }
        }
        ...
        public int CD
        {
            get
            {
                ...
                if (critValue > int.MaxValue)
                {
                    critValue = int.MaxValue;
                }
                else if (critValue < int.MinValue)
                {
                    critValue = int.MinValue;
                }
        ...
        public int SCD
        {
            get
            {
                ...
                int sentCalculation = calculated == 0 ? 10000 : calculated;
                return calculated + DeckBuffCalculation(DeckBookInfoTypesEnum.SK, sentCalculation);
            }
        }
        ...
        /// Transcends the current partner.
        /// </summary>
        public void Ascended() => HatchGrade = DigimonHatchGradeEnum.Ascended;

        /// <summary>
        /// Transcends the current partner.
        /// </summary>
        public void HighAscended() => HatchGrade = DigimonHatchGradeEnum.HighAscended;

        /// <summary>
        /// Transcends the current partner.
        /// </summary>
        public void UltraAscended() => HatchGrade = DigimonHatchGradeEnum.UltraAscended;

        /// <summary>
        /// Transcends the current partner.
        /// </summary>
        public void Ultimate() => HatchGrade = DigimonHatchGradeEnum.Ultimum;
