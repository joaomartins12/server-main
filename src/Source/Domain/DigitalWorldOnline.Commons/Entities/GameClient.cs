...
namespace DigitalWorldOnline.Commons.Entities
{
    ...
    public class GameClient
    {
        ...
        public Dictionary<int, DateTime> LastDeckResetTimes { get; set; } = new();
        ...
        // Adiciona a propriedade para desabilitar as mensagens de crítico
        public bool EnableCriticalMessages { get; set; } = false; // Desabilitado por padrão

        // Outros campos e propriedades da classe GameClient
